...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\cnack\\Desktop\\Stroop_squared\\Stroop_Squared_All_3_lastrun.py',
...
stroop_all_loop = data.TrialHandler(nReps=3.0, method='sequential', 
...
for thisStroop_all_loop in stroop_all_loop:
    ...
    routineTimer.reset()
# completed 3.0 repeats of 'stroop_all_loop'
